...
import { CustomHeaderEntries } from "../../timeline_components/CustomHeader/CustomHeader";
import { EntriesDateTimePicker } from "../../timeline_components/EntriesComponents/EntriesComponents";
...
class Agenda extends React.Component {
          ...
          <React.Fragment>
            {customHeader ? (
              <CustomHeaderEntries
                ...
                dateColRef={this.dateColRef}
                timeColRef={this.timeColRef}
              />
            ) : (
  ...
  renderDay = (day, events, dayKey) => {
    ...
    return events.map((event, idx) => {
      ...
      //* Custom Entries table for Agenda View
          ...
          <td>
            <table>
              <tbody>
                ...
                <tr>
                  <td className="rbc-agenda-time-cell">
                    <EntriesDateTimePicker event={event} />
                  </td>
                </tr>
              </tbody>
            </table>

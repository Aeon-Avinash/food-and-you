...
export const updateObjProp = (oldObject, updateVal, ...updateKeyPath) => {
  try {
...
export const updateObjAddToArr = (oldObject, updateVal, ...updateArrPath) => {
  try {
...
export const updateArrInObjAddOrReplaceByAccessor = (
  oldObject,
  updateVal,
  accessor,
  ...updateArrPath
...
export const updateObjRemoveFromArrByAccessor = (
  oldObject,
  removeItem,
  accessor,
  ...updateArrPath
...
export const getNestedObjValue = (object, ...readKeyPath) => {
  try {

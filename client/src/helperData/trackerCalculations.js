...
export const createEntry = (resData, resourceType) => {
...
export const createMealPlan = (recipeDetail, resourceType) => {
...
export const createDaySummary = (prevEntry, newEntry, entries) => {
